...
// part a  --------- adding student to table ----------
         ...
         for(int i=0;i<dataSize;i++) {
             ...
             // using hash function to find linkedlist(place) which the student will be put into 
         ...
         System.out.println("\n(part a) Fetch the students from the ArrayList, then hash and allocate them into the table we created in "+(end-start)+" millisecond\n" ); 
         System.out.println("-----------------------------------------------------------------------------------------------------------------------------------------");
         //display() ;
